                        ...
                        <div class="input-group">
                            ...
                            <div class="group-actions ms-2" style="display: none;">
                                ...
                                <button class="btn btn-outline-danger btn-sm" id="removeFromGroup">
                                    <i class="fas fa-minus me-1"></i>Remove Materials
                                </button>
                                <button class="btn btn-outline-secondary btn-sm" id="editGroupFiles">
                                    <i class="fas fa-edit me-1"></i>Edit Materials
                                </button>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-content">
            <form id="uploadForm" enctype="multipart/form-data">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Upload Marketing Materials</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control select2-multiple" id="upload_manufacturer_id" name="manufacturer_ids[]"
                                    multiple="multiple">
                                </select>
                            </div>
                            <div class="form-group mb-3">
                            ...
                            <div class="form-check mb-3">
                                ...
                                <label class="form-check-label" for="is_featured">Featured Marketing Material</label>
                            </div>
                        </div>
                        <div class="col-md-12">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group mb-3">
                                <label>Manufacturers</label>
                                <select class="form-control select2-multiple" id="edit_manufacturer_id" name="manufacturer_ids[]"
                                    multiple="multiple">
                                </select>
                            </div>
                            <div class="form-group mb-3">
                            ...
                            <div class="form-check mb-3">
                                ...
                                <label class="form-check-label" for="edit_is_featured">Featured Marketing Material</label>
                            </div>
                        </div>
                        <div class="col-md-12">
...
<script>
    ...
    $(document).ready(function() {
        $('#materialGrid').addClass('grid-view');
        ...
        $('.view-toggle').click(function() {
            ...
            if (currentView !== viewType) {
                ...
                $('#materialGrid').removeClass('grid-view list-view').addClass(`${viewType}-view`);
                const currentGroup = $('#groupFilter').val();
                const currentType = $('.btn-filter.active').data('filter') || 'all';
                const currentTag = $('#tagFilter').val();
                loadMaterials(currentType, currentGroup, currentTag);
            }
        });

        let myDropzone = new Dropzone("#materialDropzone", {
        ...
        myDropzone.on("complete", function() {
            if (this.getUploadingFiles().length === 0 && this.getQueuedFiles().length === 0) {
                loadMaterials($('.btn-filter.active').data('filter'));
                loadGroups();
            }
        });
        ...
        function loadMaterials(type = 'all', group = '', tag = '') {
            showLoading();
            $.ajax({
                ...
                success: function(response) {
                    ...
                    grid.empty();
                    grid.addClass(`${currentView}-view`);
                    if (!response.data || response.data.length === 0) {
                        grid.html(
                            `
                            <div class="col-12 text-center py-5">
                                <i class="fas fa-inbox fa-3x mb-3 text-muted"></i>
                                <h4 class="text-muted">No marketing materials found</h4>
                        ...
                        response.data.forEach(file => {
                            grid.append(createMaterialCard(file, currentView));
                        });
                    }
                    hideLoading();
                },
                error: function(xhr) {
                    hideLoading();
                    toastr.error('Error loading marketing materials');
                }
            });
        }
            ...
            if (viewType === 'list') {
                            ...
                            <div class="card-body p-3">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        ...
                                        <!-- List View Accordion -->
                                        <div class="accordion accordion-flush mt-2" id="materialListAccordion${file.id}">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="accordion-item">
                                                        ...
                                                        <div id="industriesListCollapse${file.id}" class="accordion-collapse collapse"
                                                            data-bs-parent="#materialListAccordion${file.id}">
                ...
                return `
                    ...
                    file.file_type === 'video' ? `
                                    ...
                                    <div class="document-thumbnail d-flex align-items-center justify-content-center<div class="document-thumbnail d-flex align-items-center justify-content-center"
                            ...
                            <div class="card-body">
                                ...
                                <!-- Grid View Accordion -->
                                <div class="accordion accordion-flush mt-2" id="materialAccordion${file.id}">
                                    <div class="accordion-item">
                                        <h2 class="accordion-header">
                                            <button class="accordion-button collapsed p-2" type="button" data-bs-toggle="collapse"
                                        ...
                                        <div id="industriesCollapse${file.id}" class="accordion-collapse collapse"
                                            data-bs-parent="#materialAccordion${file.id}">
                                            <div class="accordion-body p-2">
                                                ${Array.isArray(file.industries) && file.industries.length > 0
                                                    ? file.industries.map(industry =>
                                                        `<span class="badge bg-primary me-1 mb-1">${industry.name}</span>`
        ...
        $(document).on('change', '.material-checkbox', function() {
            ...
            selectedMaterialIds = $('.material-checkbox:checked').map(function() {
                return $(this).data('id');
            }).get();
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response && response.data) {
                        ...
                        $('#edit_material_id').val(fileIds.join(','));
        ...
        $('.bulk-delete').click(function() {
            ...
            if (confirm('Are you sure you want to delete this group? This will permanently delete all files in this group.')) {
                showLoading();
                $.ajax({
                    url: `/admin/marketing-materials/groups/${selectedGroup}`,
                    type: 'DELETE',
                    data: {
                        _token: $('meta[name="csrf-token"]').attr('content')
                    },
        ...
        $('#tagFilter').on('input', function() {
            ...
            tagFilterTimeout = setTimeout(() => {
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        hideLoading();
                        toastr.error('Error filtering marketing materials');
        ...
        $('.btn-filter').click(function() {
            ...
            const selectedGroup = $('#groupFilter').val();
            const materialType = $(this).data('filter');
            if (materialType === 'all') {
                $('#groupFilter').val('').trigger('change');
                loadMaterials('all', '', currentTag);
            } else {
                loadMaterials(materialType, selectedGroup, currentTag);
            }
        });
        ...
        $(document).on('click', '.edit-material', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (material.group && material.group.name) {
                        $('#edit_group').val(material.group.name);
                    } else {
                        $('#edit_group').val('');
                    }
                    if (material.tags && Array.isArray(material.tags)) {
                        $('#edit_tags').val(material.tags.map(tag =>
                            typeof tag === 'string' ? tag : tag.name
                        ).join(', '));
                    }

                    // Setup Select2 for industries
                    ...
                    // Setup Select2 for manufacturers
                    ...
                    // Set selected values
                    if (material.industries && material.industries.length > 0) {
                        material.industries.forEach(industry => {
                            const newOption = new Option(industry.name, industry.id, true, true);
                            $('#edit_industry_interests').append(newOption);
                        });
                        $('#edit_industry_interests').trigger('change');
                    }

                    if (material.dealers && material.dealers.length > 0) {
                        material.dealers.forEach(dealer => {
                            const newOption = new Option(dealer.name, dealer.id, true, true);
                            $('#edit_dealer_id').append(newOption);
                        });
                        $('#edit_dealer_id').trigger('change');
                    }

                    if (material.manufacturers && material.manufacturers.length > 0) {
                        material.manufacturers.forEach(manufacturer => {
                            const newOption = new Option(manufacturer.name, manufacturer.id, true, true);
                            $('#edit_manufacturer_id').append(newOption);
                        });
                        $('#edit_manufacturer_id').trigger('change');
                    }
                    ...
                    if (material.file_path) {
                        const mockFile = {
                            ...
                            status: "success",
                            accepted: true,
                            url: material.url || (material.file_path ? asset('storage/' + material.file_path) : null)
                        };
                ...
                error: function(xhr) {
                    hideLoading();
                    console.error('Error loading material:', xhr.responseJSON);
                    toastr.error('Error loading material details: ' + (xhr.responseJSON?.message || 'Unknown error'));
                }
            });
        });
        ...
        $('.bulk-add').click(function() {
            ...
            $.ajax({
                url: '/admin/marketing-materials/bulk-info',
                type: 'GET',
                data: {
                ...
                success: function(response) {
                    if (response && response.common) {
                        ...
                        if (response.common.industry_ids && Array.isArray(response.common.industry_ids)) {
                            $('#upload_industry_interests').val(response.common.industry_ids).trigger('change');
                        } else {
                            $('#upload_industry_interests').val(null).trigger('change');
                        }
                        if (response.common.dealer_ids && Array.isArray(response.common.dealer_ids)) {
                            $('#upload_dealer_id').val(response.common.dealer_ids).trigger('change');
                        } else {
                            $('#upload_dealer_id').val(null).trigger('change');
                        }
                        if (response.common.manufacturer_ids && Array.isArray(response.common.manufacturer_ids)) {
                            $('#upload_manufacturer_id').val(response.common.manufacturer_ids).trigger('change');
                        } else {
                            $('#upload_manufacturer_id').val(null).trigger('change');
                        }
                        $('#is_featured').prop('checked', response.common.is_featured || false);
                    }
                },
                error: function(xhr, status, error) {
                    console.error('Error fetching bulk info:', error);
                    toastr.error('Error loading material information');
                }
            });
        });
        ...
        $('#groupFilter').change(function() {
            ...
            const currentTag = $('#tagFilter').val().trim();
            const currentType = $('.btn-filter.active').data('filter') || 'all';
            loadMaterials(currentType, selected, currentTag);
        });
        ...
        $('#removeFromGroup').click(function() {
            const selectedGroup = $('#groupFilter').val();
            const selectedFiles = $('.material-checkbox:checked').map(function() {
                return $(this).data('id');
            }).get();
            ...
            if (confirm('Are you sure you want to remove selected files from this group?')) {
                $.ajax({
                    url: '/admin/marketing-materials/remove-from-group',
                    type: 'POST',
                    data: {
                        _token: $('meta[name="csrf-token"]').attr('content'),
                        group_name: selectedGroup,
                        material_ids: selectedFiles
                    },
                    success: function() {
        ...
        function getAssignedUsers(industryIds, dealerIds, manufacturerIds) {
            return $.ajax({
                url: '/admin/marketing-materials/assigned-users',
                type: 'POST',
                data: {
        ...
        function updateAssignedUsers(industryIds, dealerIds, manufacturerIds, targetElement) {
            ...
            getAssignedUsers(industryIds, dealerIds, manufacturerIds)
                .done(function(response) {
                    ...
                    Object.entries(usersByCompany).forEach(([company, users]) => {
                        ...
                        users.forEach(user => {
                            section.find('.users-list').append(`
