        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <table class="table table-bordered table-hover align-middle" id="DealerDataTable">
                            <thead>
                                <tr>
                                    <th>Name</th>
        ...
        $('#addForm').submit(function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    $('#addModal').modal('hide');
                    $('#addForm')[0].reset();
                    $('#DealerDataTable').DataTable().ajax.reload();
                    toastr.success('Dealer added successfully');
                },
                error: function () {
