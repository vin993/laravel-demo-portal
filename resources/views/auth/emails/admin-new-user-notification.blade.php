...
<div class="email-container">
	...
	<div class="content">
		...
		<div class="link-container">
			...
			<p><strong>Phone:</strong> {{ $user->userDetail->phone }}</p>
			<p><strong>Location:</strong> {{ $user->userDetail->city }}, {{ $user->userDetail->state }},
				{{ $user->userDetail->country }}</p>
		</div>
		<div class="button">
			<a href="{{ url('admin/dashboard') }}" class="reset-button">Review User</a>
		</div>
	</div>
	<div class="footer">
