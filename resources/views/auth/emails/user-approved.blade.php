...
<head>
	...
	<title>Account Approved - Demo App</title>
<style>
body {
...
<div class="email-container">
	...
	<div class="content">
		...
		<p>Hello {{ $user->name }},</p>
		<p>Great news! Your account at Demo App has been approved by our admin team.</p>
		<p>You can now log in to your account using your registered email and password.</p>
		<div class="button">
			<a href="{{ url('login') }}" class="reset-button">Login Now</a>
		</div>
