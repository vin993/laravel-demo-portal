...
<div class="email-container">
	...
	<div class="content">
		...
		<div class="link-container">
			...
			@if($user->invitedBy)
				<p><strong>Primary Account:</strong> {{ $user->invitedBy->name }} ({{ $user->invitedBy->email }})</p>
			@endif
			@if($userMessage)
				<p><strong>Additional Message:</strong> {{ $userMessage }}</p>
			@endif
		</div>
		<div class="button">
			<a href="{{ url('admin/dashboard') }}" class="reset-button">Review Request</a>
		</div>
	</div>
	<div class="footer">
